    ...
    <div className="relative pt-28 pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} className="mb-4">
          <Link to="/" className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-900 dark:hover:text-white transition-colors group">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <span className="text-xs font-mono text-primary tracking-[0.3em] uppercase mb-3 block">— Contact</span>
